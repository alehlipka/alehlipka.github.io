...
Поддержка Wayland в GLFW 3.3 была "сырой", и многие API GLFW невозможно было реализовать под Wayland из-за его ограничений.
